...
The Lie algebra so(3), associated with SO(3), is the set of $$3\times3$$ **skew-symmetric or anti-symmetric** matrices (i.e., $$A^T=-A$$). The **infinitestimal generators** of so(3) correspond to the derivatives of rotation around the each of the standard axes, evaluated at the identity.
